...
unit    class Hypervisor::IBM::POWER::HMC::REST::ManagedSystems::ManagedSystem::AssociatedSystemIOConfiguration::IOAdapters::IOAdapterChoice::IOAdapter:api<1>:auth<Mark Devine (mark@markdevine.com)>
